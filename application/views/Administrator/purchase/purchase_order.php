    ...
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="invoice" name="invoice" v-model="purchase.invoice" readonly
                        style="height:26px;" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <v-select id="branchDropdown" v-bind:options="branches" v-model="selectedBranch" label="Brunch_name"
                        disabled></v-select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input class="form-control" id="purchaseDate" name="purchaseDate" type="date"
                        v-model="purchase.purchaseDate" v-bind:disabled="userType == 'u' ? true : false"
                        style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 230px;" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-xs-7">
                                    <v-select v-bind:options="suppliers" v-model="selectedSupplier"
                                        v-on:input="onChangeSupplier" label="display_name"></v-select>
                                </div>
                                <div class="col-xs-1" style="padding: 0;">
                                    <a href="<?= base_url('supplier') ?>" title="Add New Supplier"
                            ...
                            <div class="form-group" style="display:none;"
                                v-bind:style="{display: selectedSupplier.Supplier_Type == 'G' ? '' : 'none'}">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" placeholder="Supplier Name" class="form-control"
                                        v-model="selectedSupplier.Supplier_Name" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" placeholder="Mobile No" class="form-control"
                                        v-model="selectedSupplier.Supplier_Mobile"
                                        v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? false : true" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <textarea class="form-control" v-model="selectedSupplier.Supplier_Address"
                                        v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? false : true"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <form v-on:submit.prevent="addToCart">
                                <div class="form-group">
                                    <label class="col-sm-4 control-label no-padding-right"> Warehouse </label>
                                    <div class="col-sm-7">
                                        <v-select v-bind:options="onlyBranch" v-model="selectedWarehouse"
                                            label="Brunch_name"></v-select>
                                    </div>
                                    <div class="col-sm-1" style="padding: 0;">
                                        <a href="<?= base_url('brunch') ?>" title="Add New Warehouse"
                                            class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank"><i class="fa fa-plus" aria-hidden="true"
                                                style="margin-top: 5px;"></i></a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-7">
                                        <v-select v-bind:options="products" v-model="selectedProduct"
                                            label="display_text" v-on:input="onChangeProduct"></v-select>
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <a href="<?= base_url('product') ?>" title="Add New Product"
                                            class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank"><i class="fa fa-plus" aria-hidden="true"
                                                style="margin-top: 5px;"></i></a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" id="purchaseRate" class="form-control"
                                            placeholder="Pur. Rate" v-model="selectedProduct.Product_Purchase_Rate"
                                            v-on:input="productTotal" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-4 control-label no-padding-right">Total Quantity </label>
                                    <div class="col-xs-8">
                                        <input type="number" step="1" min="0" id="quantity" class="form-control"
                                            placeholder="" ref="quantity" v-model="selectedProduct.quantity"
                                            v-on:input="productTotal" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <div class="col-xs-3">
                                        <input type="text" id="cost" name="cost" class="form-control" placeholder="Cost"
                                            readonly />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" id="productTotal" name="productTotal" class="form-control"
                                            readonly v-model="selectedProduct.total" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" id="sellingPrice" name="sellingPrice" class="form-control"
                                            v-model="selectedProduct.Product_SellingPrice" />
                                    </div>
                                </div>
                ...
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        <tr v-for="(product, sl) in cart">
                            ...
                            <td>
                                <input type="text" v-model="product.purchaseRate" class="form-control"
                                    v-on:input.prevent="updateCart(product)" style="color: #000;text-align: center;">
                            </td>
                        ...
                        <tr>
                            <td colspan="4"><textarea style="width: 100%;font-size:13px;" placeholder="Note"
                                    v-model="purchase.note"></textarea></td>
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="subTotal" name="subTotal"
                                                        class="form-control" v-model="purchase.subTotal" readonly />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="vatPercent" name="vatPercent"
                                                        v-model="vatPercent" v-on:input="calculateTotal"
                                                        style="width:50px;height:25px;" />
                                                    <span style="width:20px;"> % </span>
                                                    <input type="number" id="vat" name="vat" v-model="purchase.vat"
                                                        readonly style="width:140px;height:25px;" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="discount" name="discount"
                                                        class="form-control" v-model="purchase.discount"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="freight" name="freight"
                                                        class="form-control" v-model="purchase.freight"
                                                        v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Lifting /
                                                    Loading Cost</label>
                                                <div class="col-xs-12">
                                                    <input type="number" id="loading_cost" name="loading_cost"
                                                        class="form-control" v-model="purchase.loading_cost"
                                                        v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="total" class="form-control"
                                                        v-model="purchase.total" readonly />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12">
                                                    <input type="number" id="paid" class="form-control"
                                                        v-model="purchase.paid" v-on:input="calculateTotal"
                                                        v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? true : false" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Previous
                                                    Due</label>
                                                <div class="col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <input type="number" id="due" name="due" class="form-control"
                                                        v-model="purchase.due" readonly />
                                                </div>
                                                <div class="col-xs-6">
                                                    <input type="number" id="previousDue" name="previousDue"
                                                        class="form-control" v-model="purchase.previousDue" readonly
                                                        style="color:red;" />
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    <input type="button" class="btn btn-success" value="Purchase"
                                                        ...
                                                        v-bind:disabled="purchaseOnProgress == true ? true : false"
...
new Vue({
    ...
    computed: {
        onlyBranch() {
            let branchId = this.selectedBranch.brunch_id;
            return this.branches.filter(ele => (ele.MainBranch_Id == branchId || ele.brunch_id == branchId));
        }
    },
    methods: {
        updateCart(data) {
            this.cart.forEach(ele => {
                if (ele.id == data.id) {
                    ele.total = ele.quantity * ele.purchaseRate;
                }
            })
            this.calculateTotal();
        },
        ...
        getProducts() {
            axios.post('/get_products', {
                ...
                this.products = res.data.map(ele => {
                    ele.total = 0;
                    ele.quantity = 0;
                    ele.convert_quantity = 0;
                    return ele;
                });
            })
        },
        ...
        onChangeProduct() {
            ...
            document.querySelector("#convert_quantity_name").innerHTML = this.selectedProduct.convert_to_name;
            document.querySelector("#convert_quantity").placeholder = this.selectedProduct.convert_to_name;
            document.querySelector("#quantity").placeholder = this.selectedProduct.Unit_Name;
        ...
        productTotal() {
            ...
            if (this.selectedProduct.Product_SlNo != '') {
                let totalQty =  parseFloat(this.selectedProduct.quantity);

                this.selectedProduct.total = totalQty * parseFloat(this.selectedProduct.Product_Purchase_Rate);
            }
        },
        addToCart() {
            ...
            if (this.selectedWarehouse.brunch_id == '') {
            ...
            let product = {
                ...
                branchId: this.selectedWarehouse.brunch_id,
            }
        ...
        clearSelectedProduct() {
            ...
            document.querySelector("#convert_quantity_name").innerHTML = '';
        },
        calculateTotal() {
            ...
            this.purchase.total = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) +
                parseFloat(this.purchase.freight) +
                parseFloat(this.purchase.loading_cost)) - parseFloat(this.purchase.discount)).toFixed(2);
        ...
        getPurchase() {
            axios.post('/get_purchases', {
                ...
                this.purchase.loading_cost = purchase.PurchaseMaster_loadingCost;
                ...
                r.purchaseDetails.forEach(product => {
                    let cartProduct = {
                        ...
                        branchId: product.PurchaseDetails_branchID,
                    }
