                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" v-model="quotation.customerName"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" placeholder="Mobile No" class="form-control"
                                        v-model="quotation.customerMobile" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea placeholder="Address" class="form-control"
                                        v-model="quotation.customerAddress"></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        ...
                        <tr>
                            <td colspan="7"><textarea style="width: 100%;font-size:13px;"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="number" class="form-control" v-model="vatPercent"
                                                        v-on:input="calculateTotal" />
                                                </div>
                                                <label class="col-sm-1 control-label no-padding-right">%</label>
                                                <div class="col-sm-7">
                                                    <input type="number" readonly class="form-control"
                                                        v-model="quotation.vat" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-3">
                                                    <input type="button" class="btn btn-default" value="Save"
                                                        v-on:click="saveQuotation" style="color:#fff;margin-top: 0px;">
                                                </div>
                                                <div class="col-sm-4">
    ...
    methods: {
        ...
        getQuotations() {
            axios.post('/get_quotations', {
                ...
                this.quotation.terms_condition = quotation.SaleMaster_Description;
