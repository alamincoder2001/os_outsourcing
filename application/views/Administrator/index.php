		...
		<div class="navbar-container ace-save-state" id="navbar-container">
			...
			<div class="navbar-buttons navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					<?php
						$pending = $this->db->query("SELECT sm.* FROM tbl_salesmaster sm WHERE sm.Status = 'p'")->result();
					?>
					<li style="position: relative;">
						<a href="<?php echo base_url(); ?>salesApprove"><big>Approve Sale</big> <span style="color: #dbdbdb;background: #2e6589;position: absolute;top: 0;left: -18px;padding: 0px 5px;"><?= count($pending) ?></span></a>
					</li>
					<?php
