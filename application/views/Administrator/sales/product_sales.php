...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Mkt. Officer </label>
                <div class="col-sm-2">
                ...
                <div class="widget-main">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <!-- <h4 style="padding-left: 10px;margin-top:15px">SHIP TO:</h4>
							<div class="form-check form-check-inline" style="padding: 0px 13px;text-align:right">
								<input class="form-check-input" type="checkbox" id="inlineCheckbox22" v-model="sameAddress" value="1" v-bind:disabled="selectedCustomer.Customer_SlNo == '' ? true : false">
								<label class="form-check-label" for="inlineCheckbox22">Same Address</label>
							</div> -->

                            <div class="form-group clearfix">
                                <label class="col-sm-4 control-label no-padding-right"
                                    style="margin-top: 20px;font-weight:bold">SHIP TO: </label>
                                <div class="col-sm-8" style="padding: 0px 13px;text-align:right;margin-top: 20px">
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-xs-4">
                                        <input type="number" id="ProductDiscountPercent" placeholder="%" step="0.01"
                                            min="0.00" class="form-control" v-model="Product_DiscountPercent"
                                            v-on:input="productTotal" />
                                    </div>
                                    <div class="col-xs-1 no-padding">Tk.</div>
                                    <div class="col-xs-4">
                                        <input type="number" id="ProductDiscountTaka" placeholder="Taka" step="0.01"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="number" step="0.01" min="0" id="quantity" placeholder=""
            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        ...
                        <tr>
                            <td colspan="5"><textarea style="width: 100%;font-size:13px;" placeholder="Note"
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Lifting/Loading
                                                    Cost</label>
                                                <div class="col-xs-12">
                                                    <input type="number" class="form-control"
                                                        v-model="sales.loadingCost" v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    methods: {
        ...
        productTotal() {
            if (event.target.id == 'ProductDiscountPercent') {
                this.selectedProduct.Product_DiscountTaka = ((parseFloat(this.selectedProduct
                    .Product_SellingPrice) * parseFloat(this.Product_DiscountPercent)) / 100).toFixed(2);
            } else {
                this.Product_DiscountPercent = ((parseFloat(this.selectedProduct.Product_DiscountTaka) * 100) /
                    parseFloat(this.selectedProduct.Product_SellingPrice)).toFixed(2);
            }

            this.selectedProduct.total = ((parseFloat(this.selectedProduct.quantity)) * parseFloat(this.selectedProduct.Product_SellingPrice - this
                .selectedProduct.Product_DiscountTaka)).toFixed(2);
        },
        onSalesTypeChange() {
        ...
        async productOnChange() {
            ...
            this.selectedProduct.Product_DiscountTaka = 0.00;

            this.$refs.quantity.focus();
            if (this.selectedProduct.Product_SlNo != '') {

                document.querySelector("#convert_quantity_name").innerHTML = this.selectedProduct
                    .convert_to_name;
            }
        },
        ...
        addToCart() {
            let product = {
                ...
                salesDiscount: this.selectedProduct.Product_DiscountTaka,
        ...
        calculateTotal() {
            ...
            this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this
                .sales.transportCost) + parseFloat(this
                .sales.loadingCost)) - parseFloat(this.sales.discount)).toFixed(2);
        ...
        async saveSales() {
            ...
            // 	alert('Select a Marketing Officer');
            // 	return;
            // }
        ...
        async getSales() {
            await axios.post('/get_sales', {
                ...
                let r = res.data;
                let sales = r.sales[0];
                if (this.userType == 'u' && sales.isEditEnable == 'no') {
                ...
                if (this.sales.shipping_cus_name != null) {
                ...
                r.saleDetails.forEach(product => {
                    let cartProduct = {
                        ...
                        salesDiscount: product.SaleDetails_Discount,
